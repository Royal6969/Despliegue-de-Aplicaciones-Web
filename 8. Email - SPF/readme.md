...
- [Correo Electrónico - SPF](#correo-electrónico---spf)
- [1. Añadir el registro DNS](#1-añadir-el-registro-dns)
- [2. ¿Qué es un registro DNS tipo SPF?](#2-qué-es-un-registro-dns-tipo-spf)
    - [Resumen](#resumen)
  - [2.1. Formato del Registro SPF](#21-formato-del-registro-spf)
    - [Resumen](#resumen-1)
  - [2.2. Mecanismos(etiquetas) del Registro SPF](#22-mecanismosetiquetas-del-registro-spf)
    - [Resumen de nuestros mecanismos SPF](#resumen-de-nuestros-mecanismos-spf)
  - [2.3. Calificadores de Registro SPF](#23-calificadores-de-registro-spf)
  - [2.4. Ejemplos de cómo funciona SPF en diferentes situaciones](#24-ejemplos-de-cómo-funciona-spf-en-diferentes-situaciones)
    - [Ejemplo 1](#ejemplo-1)
    - [Ejemplo 2](#ejemplo-2)
    - [Ejemplo 3](#ejemplo-3)
- [3. Activar el email de IONOS](#3-activar-el-email-de-ionos)
    - [Comprobación final - prueba de email](#comprobación-final---prueba-de-email)
  - [Resources](#resources)
    - [Definir el registro SPF: configuración avanzada](#definir-el-registro-spf-configuración-avanzada)
    - [Cómo Microsoft 365 usa el marco de directivas de remitente (SPF) para evitar la suplantación de identidad](#cómo-microsoft-365-usa-el-marco-de-directivas-de-remitente-spf-para-evitar-la-suplantación-de-identidad)
- [4. Pasos siguientes: DKIM y DMARC](#4-pasos-siguientes-dkim-y-dmarc)
  - [4.1. Evitar el spoofing y el spam con SPF](#41-evitar-el-spoofing-y-el-spam-con-spf)
  - [4.2. Evitar el spoofing y el spam con DKIM](#42-evitar-el-spoofing-y-el-spam-con-dkim)
  - [4.3. Evitar el spoofing y el spam con DMARC](#43-evitar-el-spoofing-y-el-spam-con-dmarc)
- [5. Prueba final - Ejemplo práctico - Pregunta Teoría](#5-prueba-final---ejemplo-práctico---pregunta-teoría)
  - [¿Por qué Google pone el interrogante rojo?](#por-qué-google-pone-el-interrogante-rojo)
  - [Respuesta](#respuesta)
