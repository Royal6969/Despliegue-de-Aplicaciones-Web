...
- [1. Headers](#1-headers)
  - [1.1. Importación (include)](#11-importación-include)
  - [1.2. headers.conf](#12-headersconf)
- [2. Explicación de los Headers](#2-explicación-de-los-headers)
  - [2.1. Server Tokens](#21-server-tokens)
  - [2.2. X-Frame-Options](#22-x-frame-options)
  - [2.3. X-XSS-Protection](#23-x-xss-protection)
  - [2.4. X-Content-Type-Options](#24-x-content-type-options)
  - [2.5. Content-Security-Policy (Explicación 1)](#25-content-security-policy-explicación-1)
    - [2.5.1. Función anti cross site scripting (XSS)](#251-función-anti-cross-site-scripting-xss)
    - [2.5.2. Función anti packet sniffing attacks](#252-función-anti-packet-sniffing-attacks)
    - [2.5.3. En Resumen](#253-en-resumen)
    - [2.5.4. Aplicación - Sintaxis del CSP](#254-aplicación---sintaxis-del-csp)
    - [2.5.5. Posibles Directivas de Política](#255-posibles-directivas-de-política)
    - [2.5.6. Ejemplos](#256-ejemplos)
  - [2.6. Content-Security-Policy (Explicación 2)](#26-content-security-policy-explicación-2)
    - [2.6.1. Principales tipos de ataques XSS](#261-principales-tipos-de-ataques-xss)
    - [2.6.2. Acciones para prevenir un ataque XSS](#262-acciones-para-prevenir-un-ataque-xss)
    - [2.6.3. Definir el header Content-Security-Policy para los permisos a los contenidos de una web](#263-definir-el-header-content-security-policy-para-los-permisos-a-los-contenidos-de-una-web)
    - [2.6.4. Sources](#264-sources)
    - [2.6.5. Conclusión](#265-conclusión)
  - [2.7. Referrer-Policy](#27-referrer-policy)
    - [2.7.1. Definición y configuración del Referrer-Policy header](#271-definición-y-configuración-del-referrer-policy-header)
- [3. Análisis de seguridad](#3-análisis-de-seguridad)
- [4. Extra: Preguntas prueba final](#4-extra-preguntas-prueba-final)
  - [4.1. X-Content-Type-Option](#41-x-content-type-option)
  - [4.2. X-Frame](#42-x-frame)
  - [4.3. XSS-Protection](#43-xss-protection)
