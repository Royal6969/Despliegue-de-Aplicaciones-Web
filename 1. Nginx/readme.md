...
- [1. Configurar Nginx](#1-configurar-nginx)
  - [1.1. Instalar Nginx y PHP](#11-instalar-nginx-y-php)
  - [1.1. Vamos al archivo php.ini](#11-vamos-al-archivo-phpini)
  - [1.2. Buscamos la línea en la que pone](#12-buscamos-la-línea-en-la-que-pone)
  - [1.3. La descomentamos y la igualamos a 0](#13-la-descomentamos-y-la-igualamos-a-0)
- [2. Configurar php-fpm](#2-configurar-php-fpm)
  - [2.1. Modificamos Listen... ponemos](#21-modificamos-listen-ponemos)
  - [2.2. Usuario con el que se ejecuta php-fpm](#22-usuario-con-el-que-se-ejecuta-php-fpm)
  - [2.3. Lista de usuarios a los que php-fpm escuchará](#23-lista-de-usuarios-a-los-que-php-fpm-escuchará)
  - [2.4. Configurar el servicio php-fpm](#24-configurar-el-servicio-php-fpm)
- [3. Configuración del server block](#3-configuración-del-server-block)
  - [3.1. Vamos a crear un archivo en la ruta /etc/nginx/conf.d/](#31-vamos-a-crear-un-archivo-en-la-ruta-etcnginxconfd)
  - [3.2. Dentro de él, vamos a poner lo siguiente:](#32-dentro-de-él-vamos-a-poner-lo-siguiente)
  - [3.3. Ahora vamos a la ruta que hemos definido como Document Root de Nginx](#33-ahora-vamos-a-la-ruta-que-hemos-definido-como-document-root-de-nginx)
  - [3.4. Dentro de este index.php definiremos la clásica función que nos informa acerca de todas las características de nuestro php](#34-dentro-de-este-indexphp-definiremos-la-clásica-función-que-nos-informa-acerca-de-todas-las-características-de-nuestro-php)
  - [3.5. De nuevo hacemos un reseteo](#35-de-nuevo-hacemos-un-reseteo)
- [4. Despliegue en Nginx](#4-despliegue-en-nginx)
  - [4.1. Vamos primero a por el portfolio](#41-vamos-primero-a-por-el-portfolio)
  - [4.2. Cambiamos los permisos del grupo](#42-cambiamos-los-permisos-del-grupo)
  - [4.3. Server block](#43-server-block)
  - [4.4. Reseteamos Nginx](#44-reseteamos-nginx)
    - [Resumen server block](#resumen-server-block)
- [5. Wordpress](#5-wordpress)
  - [5.1. Una vez dentro del DirectoryRoot de Nginx...](#51-una-vez-dentro-del-directoryroot-de-nginx)
  - [5.2. Entramos en MySQL](#52-entramos-en-mysql)
  - [5.3. Ahora vamos a crear y configurar un nuevo server block para wordpress](#53-ahora-vamos-a-crear-y-configurar-un-nuevo-server-block-para-wordpress)
    - [Resumen server block](#resumen-server-block-1)
